...
const ProfileDropdown = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            <div
                className={`absolute right-0 top-full mt-2 w-64 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1e293b] shadow-2xl z-50 overflow-hidden transition-all duration-300 ease-out ${isOpen
