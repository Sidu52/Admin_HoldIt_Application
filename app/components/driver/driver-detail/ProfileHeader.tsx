...
export default function ProfileHeader({
  ...
  driver: Driver;
  setEditDriverToogle: React.Dispatch<React.SetStateAction<boolean>>;
}) {
  const handleEditProfile = () => {
    setEditDriverToogle(true);
  };

  const handleResetPassword = () => {
    console.log("Reset password for:", driver._id);
  };

  const handleSuspendDriver = () => {
    console.log("Suspend Driver:", driver._id);
  };
