        ...
        <table className="w-full border-separate border-spacing-0">
          ...
          <tbody className="divide-y divide-border-light dark:divide-border-dark">
            {driver.map((dri) => (
              <tr
                key={dri._id}
                className={`group transition-all duration-200 hover:bg-background-light dark:hover:bg-background-dark/50 ${selectedIds.has(dri._id) ? "bg-primary/[0.02]" : ""
                  }`}
              >
                ...
                <td className="px-6 py-5 text-center">
                  {getStatusBadge(dri.account_status)}
                </td>
