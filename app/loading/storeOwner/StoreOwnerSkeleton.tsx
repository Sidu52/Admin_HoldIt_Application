export function StoreOwnerHeaderSkeleton() {
  return (
...
export function StoreOwnerFiltersSkeleton() {
  return (
...
export function StoreOwnerTableSkeleton() {
  return (
...
function StoreOwnerSkeleton() {
  return (
    <div className="w-full max-w-7xl flex flex-col gap-6 py-6 px-4 md:px-8 mx-auto">
      <StoreOwnerHeaderSkeleton />
      <StoreOwnerFiltersSkeleton />
      <StoreOwnerTableSkeleton />
    </div>
  );
}

export default StoreOwnerSkeleton;
