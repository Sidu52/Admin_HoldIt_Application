...
import { getUserNameFirstChar } from '@/app/utils/helper'
import { useUpdateProfile } from '@/app/react_queries/profile/index'
            ...
            <div className="container mx-auto p-6">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                    ...
                    <div className="flex gap-3">
                        {isEditing && <button className="px-4 py-2 rounded-lg border border-theme bg-surface text-foreground text-sm font-semibold hover:opacity-80 transition">
                            Cancel
                        </button>}
                            ...
                            <div className="bg-surface border border-theme rounded-xl p-6 md:p-8">
                                ...
                                <div className="flex flex-col md:flex-row gap-8 items-start md:items-center mb-8 border-b border-theme pb-8">
                                    ...
                                    <div className="relative group">
                                        <div className="w-20 h-20 rounded-xl flex items-center justify-center bg-background text-2xl font-bold border border-theme">
                                            {getUserNameFirstChar(profile?.first_name || '', profile?.last_name || '')}
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {[
                                        ...
                                        { label: 'Email Address', key: 'email', type: 'email', full: true },
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                className={`w-full bg-background border border-theme rounded-lg px-4 py-3 outline-none focus:ring-2 ring-primary transition ${!isEditing && 'bg-disabled border-disabled'}`}
                                            />
                                        </div>
                                    ))}
                                </div>
