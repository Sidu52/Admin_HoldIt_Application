...
const driverDetails = ({ driver_id }: { driver_id: string }) => {
  ...
  return (
    <div className="flex h-screen flex-col bg-background text-foreground relative overflow-hidden">
      <div className="flex flex-col max-w-[1200px] w-full mx-auto flex-1 min-h-0 px-6 py-5 overflow-y-auto">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-1 border-b border-slate-200 dark:border-[#324467] mt-8 shrink-0">
          <button
